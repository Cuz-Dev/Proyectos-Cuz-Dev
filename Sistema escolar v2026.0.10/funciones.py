...
def menu_docente():
    ...
    p('□ opciones □')
    es()
    p('[1] Ver areas   | [4] Estudiantes')
    p('[2] Eventos     | [5] Añadir estudiante')
    p('[3] Directivos  | [6] << Salir')
    es()
...
def menu_coordinador_():
    ...
    p('[3] Docentes disponibles  | [6] <<<< Salir')
    es()
...
def menu_acudiente_():
    ...
    linea_menu2()
    es()
    p('[1] Estudiantes  | [4] Eventos')
    p('[2] Docentes     | [5] <<<< salir')
    p('[3] Directivos')
    es()
...
def menu_rector_():
    ...
    p('[2] Docentes disponibles   | [6] Estudiantes')
    p('[3] Eventos                | [7] <<<< Salir')
    p('[4] Directivos')
    es()
