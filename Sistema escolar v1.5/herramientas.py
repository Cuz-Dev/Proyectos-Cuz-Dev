...
while True:
    try:
        from configuracion import es, p, entrada_us, finalized, error, volver, mostrar_generar, generando
        break
...
while True:
    try:
        from configuracion import numero_random, guardando, guardado_exito, salir_s, error_es, letra_random, simbolo_random
        break
...
while True:
    try:
        from UI import submenu_generador_4, submenu_invertir, submenu_contraseña_6, submenu_contraseña_8
        break
...
while True:
    try:
        from UI import menu_generador, menu_calculadora, menu_piedra_papel_tijera,menu_number_hunter
        break
