...
while True:
    try:
        from estudiantes import quitar_estudiante
        break
    ...
    def menu_docente(self):
        ...
        while True:
            ...
            opciones_docente = {
                ...
                7: self.anotaciones.Sub_Menu_Anotacion,
                8: self.cambio.Sub_Menu_cambio
    ...
    def Menu_rector(self):
        ...
        while True:
            ...
            rector = {
                ...
                8: self.mostrar.Sub_Menu_Anotacion,
                9: self.cambio.Sub_Menu_cambio
