...
def menu_docente():
    ...
    p('                                                  ║         ')
    p('╔                                                            ╗')
    p(' [1] Ver areas   | [4] Estudiantes        | [7] anotaciones')
    p(' [2] Eventos     | [5] Añadir estudiante  | [8] contraseña')
    p(' [3] Directivos  | [6] Notas estudiante   | [9] <<<< salir')
    p('╚                                                            ╝')
    es()
...
def menu_coordinador_():
    ...
    p('                                                  ║                 ══')
    p('╔                                                                  ╗')
    p(' [1] Compromisos        | [5] Añadir estudiantes | [9] <<<< salir')
    p(' [2] Reuniones          | [6] Notas estudiantes')
    p(' [3] Docentes           | [7] Anotaciones')
    p(' [4] Estudiantes        | [8] contraseña')
    p('╚                                                                  ╝')
    es()
    es()
...
def menu_rector_():
    ...
    p('                                                  ║         ')
    p('╔                                                           ╗')
    p(' [1] Areas     | [5] Agregar estudiantes | [9] contraseña    ')
    p(' [2] Docentes  | [6] Estudiantes         | [10] <<<< salir   ')
    p(' [3] Eventos   | [7] Notas estudiante                        ')
    p(' [4] Directivos| [8] Anotaciones')
    p('╚                                                           ╝')
    es()
