...
def v():
    ...
    mensaje.penup()
    mensaje.goto(0,50)
    mensaje.write("Sistema escolar v2026.0.7", align="center", font=("Arial", 25, "bold"))
    mensaje.goto(0,25)
    mensaje.write("------------------------", align="center")
    mensaje.goto(0,0)
    mensaje.write("Desarrollador Cuz-Dev",align="center", font=("Aria", 20, "bold") )
    time.sleep(2)
    turtle.bye()
...
def rector():
    while True:
        try:
            es()
            cr = int(input('¡!Hola rector!¡, Por favor dijita la clave:'))
            while cr != 202600:
                es()
                cr = int(input('[ERROR]!Clave incorrecta¡:'))
                es()
            break
    ...
    while True:
        ...
        p('------------------------------------------------')
        p('□ opciones □')
        p('[1] Areas y docentes disponibles')
        p('[2] Eventos')
        p('[3] Directivos')
        p('[4] Estudiantes')
        p('[5] <<<< Salir')
