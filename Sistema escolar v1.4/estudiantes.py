...
while True:
    try:
        ...
        from configuracion import grado_invalido,curso_invalido
        ...
        from configuracion import cursos_validos, grados_validos
        ...
        from UI import submenu_quitar_estudiante, estudiantes_sistema_menu
        from configuracion import limpiar_pantalla, error, es, p, entrada_us, grado_ejemplo, curso_ejemplo
        from configuracion import anotacion_,error_clave
